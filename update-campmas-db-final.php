...
<html lang="en">
  ...
  <div class="mdl-layout mdl-js-layout  mdl-layout--fixed-header" style="height:auto">
    ...
    $CAMP_CCDate_view=strtotime($_GET['CAMP_CDate']);
    $CAMP_CCDate_view=date('d-m-Y',$CAMP_CCDate_view);
   ...
   include 'db-conn.php';
    ...
    include 'check_page_access.php';
      ...
      $sql = "UPDATE campaign_master_final set CAMP_PKID='$ID',CAMP_EMP_BR_CODE='$CAMP_BRCode',CAMP_EMP_ID='$CAMP_E_ID',CAMP_CL_CODE='$CAMP_CL_Code',CAMP_BRD_ID='$CAMP_BR_ID',CAMP_ACTIVITY='$CAMP_Activity',CAMP_STORE_ID='$StoreIDs',CAMP_ACT_SDATE='$CAMP_ACT_SDate',CAMP_ACT_EDATE=$CAMP_ACT_EDate,CAMP_PO_NO='$CAMP_PO_Num',CAMP_PO_DATE='$CAMP_PO_Date',CAMP_REMARKS='$CAMP_Remarks',UPDATED_DATE='$Today' where CAMP_PKID='$ID'";
      ...
      <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp myTable" align="center">
        <thead>
          <tr>
            ...
            <th class="mdl-data-table__cell--numeric">Store ID(S)</th>
        ...
        <tbody>
          <tr>
            ...
            <td class="mdl-data-table__cell--non-numeric"><?php if($CAMP_Remarks!='') { echo $CAMP_Remarks; } else { echo "____________"; } ?></td>
          </tr>
        </tbody>
      </table>
    </div>
